# 来自https://www.bilibili.com/video/BV1keqaY8EY4/?spm_id_from=333.337.search-card.all.click&vd_source=98e4164f2cbf19bf54ad534e5875112c
...
def mask_logits(logits, labels):
    ...
    for logit, label in zip(logits, labels):
        # 直接用布尔索引，会把 [seq_len, vocab_size] 拉平 → [num_valid * vocab_size]
        # logit[label != 0] : [num_valid * vocab_size]
        # .sum()            : []
        # .unsqueeze(0)     : [1]
