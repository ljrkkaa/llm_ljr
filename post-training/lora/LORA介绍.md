...
https://zhuanlan.zhihu.com/p/702629428 (推导没看明白 日后再看）
...
这段话大致意思是说，在我们采用Adam做优化器时，调整的作用就相当于调整learning rate。一般而言，我们把设置 ` alpha`为我们第一次做实验时设置的r ，然后就把 `alpha`固定下来，之后只调整r即可，这样做的好处是当我们尝试不同的r时，我们不需要再去调整别的超参了。
